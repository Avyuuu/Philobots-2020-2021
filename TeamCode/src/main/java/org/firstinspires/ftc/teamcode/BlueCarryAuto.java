...
@Autonomous(name = "BlueCarry", group = "Philos")
public class BlueCarryAuto extends Autonomous_Methods {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (numberOfRings > 0) {
                if (numberOfRings == 1) {
                    autoBlueCarry(true, false, false);
...
//                    forward(0.5, 44);
                    ...
                    autoBlueCarry(false,true,false);
                    /*
                ...
                autoBlueCarry(false, false, true);
